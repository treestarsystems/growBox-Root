...
//  'mongodb://' + server, {useNewUrlParser: true}
 const client = await mongodb.MongoClient.connect(
  `mongodb://${coreVars.dbServer}`, {useNewUrlParser: true}
 );
 return client.db(coreVars.dbName).collection(collectionName);
}
